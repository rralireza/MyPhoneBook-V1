		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">PhoneBook user Login</h2>
				</div>
			</div>
			<div class="row justify-content-center">
				<div class="col-md-7 col-lg-5">
		            ...
		            <div class="form-group">
		            	<button type="submit" name="btn" class="form-control btn btn-primary rounded submit px-3">Sign In</button>
		            </div>
		          ...
		          <p class="text-center">Not a member? <a href="register.php" data-toggle="tab" >Sign Up</a></p>
		        </div>
		      </div>
				</div>
			</div>
