        ...
        <div class="jumbotron jum">
            ...
            <div class="row">
                ...
                <h5 class="mt-2">Add New Contact</h5>
                    ...
                    <input name="name" class="form-control mb-3 mt-3" placeholder="Edit Name" id="userName" type="text">
                    <div id="nameAlert" class="alert alert-danger text-justify p-2 ">Edit Edit name</div>
                    <input name="phone" class="form-control mb-3" placeholder="Edit Phone Number" id="userPhone" type="text">
                    <div id="phoneAlert" class="alert alert-danger text-justify p-2 ">Please Edit a valid number</div>
                    <input name="email" class="form-control mb-3" placeholder="Edit E-Mail" id="userEmail" type="email">
                    <div id="mailAlert" class="alert alert-danger text-justify p-2 ">Please Edit a valid e-mail</div>

                    <button class="btn btn-info w-100 btn1" name="btn">Edit</button>
